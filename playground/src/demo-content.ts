...
以上覆盖了 **alert、statistic、progress、tag、rate、descriptions、table、button、card、ordercard、result、drawer、timeline、collapse、dialog、linechart、areachart、barchart、piechart、scatterchart、candlestickchart、radarchart、graphchart** 共 23 类组件，可切换顶部组件库查看不同 UI 风格。
`

export const STREAM_CONTENT = `# Xxxxx 科技 · 年度分析报告
