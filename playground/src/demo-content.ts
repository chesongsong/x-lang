...
以上覆盖了 **alert、statistic、progress、tag、rate、descriptions、table、button、card、ordercard、form、result、drawer、timeline、collapse、dialog、linechart、areachart、barchart、piechart、scatterchart、candlestickchart、radarchart、graphchart** 共 24 类组件，可切换顶部组件库查看不同 UI 风格。
`
