...
本文档记录 x-langjs 的版本变更。格式基于 [Keep a Changelog](https://keepachangelog.com/zh-CN/1.0.0/)。
...
- **语言与运行时**
  - 基于 ANTLR4 的语法解析，无声明关键字、多作用域、Markdown 内嵌 \`\`\`x-langjs\`\`\` 代码块。
...
- **Playground**
  - Monaco 编辑器、x-langjs 语法高亮；静态 / 流式演示。
...
[0.0.1]: https://github.com/chesongsong/x-langjs/releases/tag/v0.0.1
